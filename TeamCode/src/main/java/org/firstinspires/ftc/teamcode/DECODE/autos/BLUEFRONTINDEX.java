...
@Autonomous(name = "INDEXED 12 FRONT BLUE", preselectTeleOp = "BLUE TELEOP 2", group = "blueautos")
public class BLUEFRONTINDEX extends OpMode {
    ...
    Servo flickys, flickright, leftwall, rightwall;
